...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\Web\\UserBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\Web\\ProjectBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\Web\\TagBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\Web\\PortfolioBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\Web\\PaymentBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\Web\\MessageBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Web\\UserBundle\\Entity');
        $c->addDriver($b, 'Web\\ProjectBundle\\Entity');
        $c->addDriver($b, 'Web\\TagBundle\\Entity');
        $c->addDriver($b, 'Web\\PortfolioBundle\\Entity');
        $c->addDriver($b, 'Web\\PaymentBundle\\Entity');
        $c->addDriver($b, 'Web\\MessageBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('WebUserBundle' => 'Web\\UserBundle\\Entity', 'WebProjectBundle' => 'Web\\ProjectBundle\\Entity', 'WebTagBundle' => 'Web\\TagBundle\\Entity', 'WebPortfolioBundle' => 'Web\\PortfolioBundle\\Entity', 'WebPaymentBundle' => 'Web\\PaymentBundle\\Entity', 'WebMessageBundle' => 'Web\\MessageBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c770d393020c7f43115676fef9b7ffcca317589b54c21eb92e2cb09efd14683a');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Web\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Web\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Web\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Web\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Web\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/projects/add');

        $l = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/skills');

        $m = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/edit');

        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/password-reset');

        $o = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/change-password');

        $p = new \Symfony\Component\HttpFoundation\RequestMatcher('^/u/*');

        $q = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/freelaners');

        $r = new \Symfony\Component\HttpFoundation\RequestMatcher('^/profile/projects');

        $s = new \Symfony\Component\HttpFoundation\RequestMatcher('^/projects/*/edit');

        $t = new \Symfony\Component\HttpFoundation\RequestMatcher('^/message');

        $u = new \Symfony\Component\HttpFoundation\RequestMatcher('^/payments');

        $v = new \Symfony\Component\HttpFoundation\RequestMatcher('^/portfolios');

        $w = new \Symfony\Component\HttpFoundation\RequestMatcher('^/portfolio/*');

        $x = new \Symfony\Component\HttpFoundation\RequestMatcher('^/dashboard');

        $y = new \Symfony\Component\Security\Http\AccessMap();
        $y->add($g, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $y->add($h, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $y->add($i, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $y->add($j, array(0 => 'ROLE_ADMIN'), NULL);
        ...
        $y->add($p, array(0 => 'ROLE_USER'), NULL);
        $y->add($q, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $y->add($r, array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
        $y->add($s, array(0 => 'ROLE_USER'), NULL);
        $y->add($t, array(0 => 'ROLE_USER'), NULL);
        $y->add($u, array(0 => 'ROLE_USER'), NULL);
        $y->add($v, array(0 => 'ROLE_USER'), NULL);
        $y->add($w, array(0 => 'ROLE_USER'), NULL);
        $y->add($x, array(0 => 'ROLE_USER'), NULL);

        $z = new \Symfony\Component\Security\Http\HttpUtils($d, $d);

        $aa = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $z, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($z, '/'), array('csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'logout', 'logout_path' => '/logout'));
        $aa->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $ba = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($z, array());
        $ba->setOptions(array('login_path' => '/login', 'always_use_default_target_path' => false, 'default_target_path' => '/profile', 'target_path_parameter' => '_target_path', 'use_referer' => false));
        $ba->setProviderKey('main');

        $ca = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $z, array(), $a);
        $ca->setOptions(array('login_path' => '/login', 'failure_path' => NULL, 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($y, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => new \Symfony\Component\Security\Core\User\InMemoryUserProvider(), 1 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $aa, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $this->get('security.authentication.session_strategy'), $z, 'main', $ba, $ca, array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'csrf_token_id' => 'authenticate', 'post_only' => true), $a, $c, NULL), 4 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '578388840e4eb5.90174042', $a, $f), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $y, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $z, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($e, $z, '/login', false), NULL, NULL, $a, false));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('moezmix@gmail.com');
        $a->setPassword('mizouest');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Web\\UserBundle/Resources/views'), 'WebUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\Web\\ProjectBundle/Resources/views'), 'WebProject');
        $instance->addPath(($this->targetDirs[3].'\\src\\Web\\TagBundle/Resources/views'), 'WebTag');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\javiereguiluz\\easyadmin-bundle/Resources/views'), 'EasyAdmin');
        $instance->addPath(($this->targetDirs[3].'\\src\\Web\\PortfolioBundle/Resources/views'), 'WebPortfolio');
        $instance->addPath(($this->targetDirs[3].'\\src\\Web\\PaymentBundle/Resources/views'), 'WebPayment');
        $instance->addPath(($this->targetDirs[3].'\\src\\Web\\MessageBundle/Resources/views'), 'WebMessage');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('9d7866c7aa3975d988e46a88f959fecf1329e398');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WebUserBundle' => 'Web\\UserBundle\\WebUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'WebProjectBundle' => 'Web\\ProjectBundle\\WebProjectBundle',
                'WebTagBundle' => 'Web\\TagBundle\\WebTagBundle',
                'EasyAdminBundle' => 'JavierEguiluz\\Bundle\\EasyAdminBundle\\EasyAdminBundle',
                'WebPortfolioBundle' => 'Web\\PortfolioBundle\\WebPortfolioBundle',
                'WebPaymentBundle' => 'Web\\PaymentBundle\\WebPaymentBundle',
                'WebMessageBundle' => 'Web\\MessageBundle\\WebMessageBundle',
            ...
            'mailer_user' => 'moezmix@gmail.com',
            'mailer_password' => 'mizouest',
            'secret' => '9d7866c7aa3975d988e46a88f959fecf1329e398',
            'locale' => 'en',
            ...
            'kernel.secret' => '9d7866c7aa3975d988e46a88f959fecf1329e398',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'moezmix@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'mizouest',
            ...
            'fos_user.model.user.class' => 'Web\\UserBundle\\Entity\\User',
            ...
            'easyadmin.config' => array(
                ...
                'entities' => array(
                    'User' => array(
                        'class' => 'Web\\UserBundle\\Entity\\User',
                        'edit' => array(
                            'fields' => array(
                                0 => 'username',
                                1 => 'email',
                    ...
                    'Projet' => array(
                        'class' => 'Web\\ProjectBundle\\Entity\\Projet',
                        'name' => 'Projet',
                    ),
                    'Offre' => array(
                        'class' => 'Web\\ProjectBundle\\Entity\\Offre',
                        'name' => 'Offre',
                    ),
                    'Skill' => array(
                        'class' => 'Web\\TagBundle\\Entity\\Skill',
                        'name' => 'Skill',
                    ),
                    'Portfolio' => array(
                        'class' => 'Web\\PortfolioBundle\\Entity\\Portfolio',
                        'name' => 'Portfolio',
                    ),
                    'Portfeuille' => array(
                        'class' => 'Web\\PaymentBundle\\Entity\\Portfeuille',
                        'name' => 'Portfeuille',
                    ),
                    'Message' => array(
                        'class' => 'Web\\MessageBundle\\Entity\\Message',
                        'name' => 'Message',
                    ),
                ),
                'formats' => array(
